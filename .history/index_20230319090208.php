...
<body>
    <div class="container">
        ...
        <p>Enter your details to confirm your participation in the trip. Click submit after you are finished</p>

        <?php
        if($insert) {
            echo "<p class='submitMsg'>Thanks for submitting the form. We are happy to have you join us</p>";
        }
        ?>
